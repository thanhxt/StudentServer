...
| datasource.url | string | `"jdbc:postgresql://localhost/ttx"` | URL für den DB-Zugriff |
| datasource.username | string | `"ttx"` | Benutzername für das DB-System |
...
| image.name | string | `"ttx"` | Name des Image |
